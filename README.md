...
4. Clone a recipe tab, or overwrite an existing one, to fill in the ingredients of your recipe. Only columns A, B, and C need to be modified. Column F can also be modified to calculate the recipe's per-unit cost.
